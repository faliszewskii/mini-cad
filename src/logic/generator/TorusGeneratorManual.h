...
#ifndef OPENGL_SANDBOX_TORUSGENERATORMANUAL_H
#define OPENGL_SANDBOX_TORUSGENERATORMANUAL_H

#include "MeshGenerator.h"
#include "../entities/mesh/Mesh.h"
#include "MeshGeneratorHelpers.h"

class TorusGeneratorManual : public MeshGenerator {
    int radialResolution;
    int tubularResolution;
    float radius;
    float thickness;
public:
    explicit TorusGeneratorManual(int radialResolution = 50, int tubularResolution = 50, float radius = 1, float thickness = 0.25f)
...
#endif //OPENGL_SANDBOX_TORUSGENERATORMANUAL_H
